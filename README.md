...
- Thư mục `Data/` — dữ liệu nguồn dùng cho phân tích (`.csv`, và file dữ liệu được làm sạch).  
...
3. Dán link repo hoặc trực tiếp link notebook:  
https://github.com/leduyen-it/PhanTichVaTrucQuanHoa/blob/main/PT%26TQHDL.ipynb
